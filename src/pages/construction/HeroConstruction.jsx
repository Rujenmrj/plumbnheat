        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <div className="relative inline-block">
              ...
              className="relative bg-secondary-500 hover:bg-secondary-600 text-white px-8 py-4 rounded-lg cursor-pointer font-semibold text-lg transition-all transform hover:scale-105 shadow-lg flex items-center gap-2">
                Call Us Now!
